  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      .row.justify-content-center
        ...
        .col-lg-8(data-aos="fade-left")
          .cajon.color-secundario.p-4.my-3(style="background: #FDEFF5")
            p.mt-0.mb-0 Los personajes en 2D y en 3D se diseñan, modelan y renderizan por medio de diferentes herramientas y <em>software</em> especializado, el cual cada vez más genera productos de mayor realismo y detalle.
          p.mb Para ello, se debe tener en cuenta que el proceso tecnológico del modelado, renderizado y animación debe concordar con los requerimientos iniciales del cliente expuestos en el <em>brief</em>, así el éxito del diseñador radica en seleccionar las herramientas necesarias para cumplir con las condiciones del proyecto y sus aplicaciones en el contexto. 
      
      h3(data-aos="fade-left").mb-3.mt-3.blue_icon Dimensiones 2D
  
      p(data-aos="fade-left").my-3 En el diseño e ilustración, ya sea con <em>software</em> o de manera análoga, se deben tener en cuenta diferentes aspectos al momento de finalizar los archivos entregables, los cuales son fundamentales para llevar a cabo un trabajo que cumpla con un factor estético relevante, diferenciado de otros productos en el mercado y que permita garantizar que el resultado concuerde con las especificaciones del cliente y sea ordenado. Algunos de estos aspectos:
          ...
          LineaTiempoD.color-acento-botones
            .row(numero="1" titulo="La composición")
              .col-md-12.mb-4.mb-md-0
                p A partir del espacio de trabajo es importante pensar en la composición, es decir, distribuir los objetos de la mejor manera posible, para evitar que se perciba recargado o saturado, teniendo en cuenta la gravedad visual, el equilibrio y el espacio en blanco.
            ...
            .row(numero="4" titulo="Colores")
              .col-md-12.mb-4.mb-md-0
                p La elección de las escalas cromáticas es de extremo cuidado, puesto que permite orientar al público, validar una intención y generar un ambiente gráfico que debe apoyar y definir claramente el concepto de diseño del personaje.
        ...
        .col-lg-8.col-md-12.mb-5.mb-md-0.align-content-center(data-aos="fade-left")
          LineaTiempoD.color-acento-botones
            ...
            .row(numero="2" titulo="La ubicación")
              .col-md-12.mb-4.mb-md-0
                p.text-small El diseño 3D, como su nombre lo indica, tiene tres dimensiones: altura, ancho y profundidad, por lo que la ubicación de los componentes es otro factor importante para establecer un espacio visualmente atractivo y, lo más importante, definido, con base en las orientaciones del cliente. Esto permite aprovechar la espacialidad: la ubicación de los objetos, los recorridos por los espacios y los movimientos del personaje.
      ...
      .cajon.color-secundario.p-4.mt-4(data-aos="fade-up")(style="background: #FDEFF5")
        p.mt-0.mb-0 En general, las dimensiones o estadios que pueden ser intervenidos en el diseño 2D y 3D permiten establecer, independiente del <em>software</em> usado, buenas prácticas de diseño, garantizando mejores resultados frente a aspectos estéticos, funcionales y comunicativos.
      ...
      .row.justify-content-center.my-3
        .col-lg-9(data-aos="fade-right")
          p.my-3 Es importante tener en cuenta que cambiarán las condiciones de salida, si el archivo se usará para impresiones en formato tipo tabloide o si será solo de acceso <em>web</em>; para esto es necesario identificar cuál será la finalización de archivos o la exportación de estos. 
      ...
      TabsB.color-acento-contenido.my-4(data-aos="zoom-in")(style="background: #F9EDFB")
        ...
        .tarjeta.p-5.bgr2(titulo="Imágenes" :icono="require('@/assets/curso/temas/tema2/img11.svg')")
          .row.align-content-center.justify-content-center
            .col-lg-7.align-content-center.justify-content-center     
              p Las imágenes se deben incrustar en el archivo antes de guardar y enviar. En los diferentes programas, especialmente los de trabajo 2D, se recomienda, si se trabaja con imágenes, que estas se enlacen al archivo sin incrustarse, ya que este es el último paso, el cual se realiza al momento de analizar el archivo, ya que enlazar una imagen permite llamar el archivo desde el programa sin cargarlo, lo que hace que el peso del archivo se mantenga bajo y la velocidad del trabajo pueda ser mayor.  Las imágenes incrustadas deben concordar con el sistema de color que más convenga para el proyecto.
            .col-lg-5.col-md-8.align-content-center.justify-content-center
